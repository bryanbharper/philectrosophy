...
The argument appears structurally sound. In fact, premises **3**, **4**, and **5** all follow pretty straight-forwardly from **1** and **2**. It should be obvious that **Premise 2** is the heart of the argument, so I'll spend the remainder of this post analyzing it.
...
What about our belief producing faculties, did they evolve? A musician, through rigorous training, develops a faculty for correctly identifying notes (i.e., perfect pitch). They hear a sound and form the belief *this is F#*. But this is something that is learned, not evolved. Through rigorous study logicians and mathematicians develop a faculty for derivation, but again, this is something learned.
...
So, let's suppose that the contents of beliefs have causal properties. For Plantinga's argument to work, it must be the case that these causal properties have no impact on natural selection. We've already agreed that *NP* facts impact natural selection insofar as they have *behavioral effects*. It follows that, *if belief contents have no selective impact, it's causal properties must be disjoint from those with behavioral effects.* There can be no overlap. If there was overlap, then they would play a role in natural selection.

Here's another way of putting this. Let our sample space, [IMATH]U[/IMATH], be the set of the causal properties involved in complete causal description of an organisms behavior. Let [IMATH]N[/IMATH] be the set of *NP* effects in [IMATH]U[/IMATH]. Let [IMATH]C[/IMATH] be the set of *belief content* effects in [IMATH]U[/IMATH]. And let [IMATH]E[/IMATH] be the set of effects in [IMATH]U[/IMATH] not directly caused by beliefs.  As state above, if *belief contents* play no role in natural selection, then [IMATH]N[/IMATH] and [IMATH]C[/IMATH] must form a [disjoint union](https://en.wikipedia.org/wiki/Disjoint_union). I.e., the intersection of the two sets is empty:

[MATH]N \cap C \equiv \emptyset[/MATH]

And, by definition, [IMATH]E[/IMATH] also doesn't interest with [IMATH]C[/IMATH]:

[MATH]E \cap C \equiv \emptyset[/MATH]

And so [IMATH](N \cup E)[/IMATH] and [IMATH]C[/IMATH] for a disjoint union:

[MATH](N \cup E) \cap C \equiv \emptyset[/MATH]


But there's a problem here. We already concluded that we had a complete causal description with only [IMATH]N \cup E[/IMATH]. The alien anthropologist had a complete understanding without knowledge of belief contents. So our complete causal picture [IMATH]U[/IMATH] is equivalent to the union of these facts, i.e., [IMATH](N \cup E) \equiv U[/IMATH]. However, as stated above, [IMATH]C[/IMATH] forms a disjoin union with these sets. And the only set which forms a disjoint union with a sample space is the empty set. So, since [IMATH]C[/IMATH] does not intersect with [IMATH]N \cup U[/IMATH], it must be empty, i.e., [IMATH]C \equiv \emptyset[/IMATH]. So, belief contents have no effects. They are causally inefficacious. But that's just epiphenomenalism, which we are supposing is false. Where have we gone wrong?
